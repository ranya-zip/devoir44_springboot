...
public class Director {
	...
	@RequestMapping(value="/movieDir/{idDir}",method = RequestMethod.GET)
	public List<Movie> getMoviesByDirId(@PathVariable("idDir") Long idDir) {
	return movieService.findByDirectorIdDir(idCat);
	}
